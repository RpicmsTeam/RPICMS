...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="../theme_engine/favicon.ico">

    <title>RPICMS EXAMPLE THEME - Jumbotron Template</title>

    <!-- Bootstrap core CSS -->
    <link href="../theme_engine/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="jumbotron.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../theme_engine/js/ie8-responsive-file-warning.js"></script><![endif]-->
  ...
  ?>
    ...
    <script src="../theme_engine/js/bootstrap.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="../theme_engine/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
